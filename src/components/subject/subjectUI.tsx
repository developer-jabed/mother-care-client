...
const ITEMS_PER_PAGE = 12; // change this if you want more/less cards per page
...
export default function ClassesSubjectsClient({
  ...
  const handleSubmit = () => {
    ...
    if (!editingSubject && !form.classId)
      nextErrors.classId = "ক্লাস নির্বাচন করুন";
    if (
      form.fullMarks &&
      form.passMarks &&
            ...
            {!editingSubject && (
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-gray-400 flex items-center gap-1">
                  ...
                  নির্বাচিত ক্লাসের সকল শাখায় এই বিষয়টি স্বয়ংক্রিয়ভাবে যুক্ত
                  হবে
                </p>
              </div>
            )}
            ...
            <div className="flex items-center gap-2 pt-1">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleChange("isOptional", checked === true)
                }
              />
              <Label
                htmlFor="isOptional"
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              আপনি কি নিশ্চিত যে <strong>{deleteTarget?.name}</strong> বিষয়টি
